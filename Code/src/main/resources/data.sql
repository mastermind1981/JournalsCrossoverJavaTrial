INSERT INTO user(login_name, pwd, enabled, email, role) VALUES ('publisher1', '$2a$10$RC1.YFSL8o2vCIg6kB3fjuBB639BdjY6AD8rIw9oyWJLws/1Q6Lku', TRUE, 'crossover.trial.pgyschuk+1@gmail.com', 'PUBLISHER');
INSERT INTO user(login_name, pwd, enabled, email, role) VALUES ('publisher2', '$2a$10$MUahUza86ErCxtsgpmMBDeR5VtoGHioRdl03/jQmkM/sk6L.Eg28e', TRUE, 'crossover.trial.pgyschuk+2@gmail.com', 'PUBLISHER');
INSERT INTO user(login_name, pwd, enabled, email, role) VALUES ('user1', '$2a$10$WcgRF8VQ8DKt4h4Hz9pWv.6MXnIRmcPr0j9jqsseprsBwTD4w8WSm', TRUE, 'crossover.trial.pgyschuk+3@gmail.com', 'USER');
INSERT INTO user(login_name, pwd, enabled, email, role) VALUES ('user2', '$2a$10$Q5bxyPXhHXFc1fRUMCRWR.GbgsXx9aGZdoEoEAz2JFEfckdyUKfOi', TRUE, 'crossover.trial.pgyschuk+4@gmail.com', 'USER');
